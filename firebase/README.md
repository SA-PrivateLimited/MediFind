# Firebase Setup for MediFind

This directory contains Firebase configuration and sample data for the MediFind app.
...
2. Android package name: `com.medifind`
