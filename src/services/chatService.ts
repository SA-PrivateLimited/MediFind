...
export const subscribeToMessages = (
  ...
  console.log(`Subscribing to messages for consultation ${consultationId}`);
...
export const markMessagesAsRead = async (
  ...
  try {
    console.log(
      `Marking messages as read for consultation ${consultationId}`,
    );
...
export const subscribeToTypingIndicator = (
  ...
  const unsubscribe = firestore()
    ...
    .onSnapshot(
      ...
      error => {
        console.error('Error in typing indicator subscription:', error);
      },
    );
