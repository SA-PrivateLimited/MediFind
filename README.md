...
```bash
cd "/Users/sandeepgupta/Desktop/Play Store/pharmacy_app/MediFind"
```
...
```bash
cd android/app
keytool -genkeypair -v -storetype PKCS12 -keystore medifind-release-key.keystore -alias medifind-key-alias -keyalg RSA -keysize 2048 -validity 10000
```
...
```properties
MYAPP_RELEASE_STORE_FILE=medifind-release-key.keystore
MYAPP_RELEASE_KEY_ALIAS=medifind-key-alias
...
- **Full description**:
```
MediFind is your comprehensive medicine information companion. Search for any medicine and get detailed information including ingredients, uses, side effects, and dosage recommendations.
